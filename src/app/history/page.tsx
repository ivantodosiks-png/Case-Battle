  ...
  return (
    <div className="space-y-4 pb-10">
      <div className="glass ring-soft rounded-2xl p-4">
        <div className="font-display text-lg tracking-wide text-white">История</div>
      ...
      <div className="glass ring-soft rounded-2xl p-4">
        <div className="space-y-2">
          {history.map((h) => (
            <div key={h.id} className="glass-card rounded-2xl p-3 transition hover:border-white/20">
              ...
              {h.cashback ? <div className="mt-2 text-xs text-white/60">Cashback: {h.cashback} ₽</div> : null}
            </div>
          ))}
